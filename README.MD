📺 IPTV Server with EPG & Stream Control
...
iptv-server/
├── data/
│   ├── as.json                 # Channel data
│   ├── channels.json            # Main channel configuration
│   ├── channels.backups/        # Automatic backups
│   └── epg/                     # EPG JSON files
├── fetch_epg5.py                 # Channel scraper
├── epg3.py                       # EPG updater
...
🎙️ Stream Control for Transcription
