...
javascript // In server.js, find and modify: const curlCommand = curl -X POST http://localhost:5000/start-stream ...; 


🐛 Troubleshooting Common Issues EPG files not loading
